...
class Asistencia
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Chec\UserBundle\Entity\User", inversedBy="asistencia")
     * @ORM\JoinColumn(name="user_id", referencedColumnName="id")
     */
    private $user;

    /**
     * @ORM\ManyToOne(targetEntity="Chec\UserBundle\Entity\User", inversedBy="asistencia_create_user")
     * @ORM\JoinColumn(name="create_user_id", referencedColumnName="id")
     */
    private $create_user;

    /**
     * @ORM\ManyToOne(targetEntity="Chec\UserBundle\Entity\User", inversedBy="asistencia_update_user")
